        ...
        <div class="row gx-0 align-items-center">
            <div class="col-lg-4 text-center text-lg-start mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    ...
                    <a href="{{ route('frontend.contact') }}" class="text-muted ms-2"> Contact</a>

                </div>
            </div>
            <div class="col-lg-4 text-center d-flex align-items-center justify-content-center">
                <small class="text-dark">Call Us:</small>
                <a href="#" class="text-muted">(+91) 1234 567890</a>
            </div>
                ...
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu rounded">
                            <a href="#" class="dropdown-item"> Rupee</a>
                    ...
                    <div class="dropdown">
                        @guest
                            <a href="#" class="dropdown-toggle text-muted ms-2" data-bs-toggle="dropdown"><small><i
                                        class="fa fa-home me-2"></i> Login\Register</small></a>
                            <div class="dropdown-menu rounded">
                        ...
                        @else
                            <a href="#" class="dropdown-toggle text-muted ms-2" data-bs-toggle="dropdown"><small><i
                                        class="fa fa-home me-2"></i> {{ Auth::user()->name }}</small></a>
                            <div class="dropdown-menu rounded">
                                <a href="{{ route('buyer.dashboard') }}" class="dropdown-item"> My Dashboard</a>
                    ...
                    <div class="d-inline-flex align-items-center">
                        <a href="{{ route('frontend.index') }}" class="navbar-brand p-0">
                            <h1 class="display-5 text-white m-0"><i
                                    class="fas fa-shopping-bag text-secondary me-2"></i>vShop</h1>
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-primary ">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto py-0">
                            ...
                            <a href="{{ route('frontend.contact') }}" class="nav-item nav-link me-2">Contact</a>
                        </div>
                        <a href="" class="btn btn-secondary rounded-pill py-2 px-4 px-lg-3 mb-3 mb-md-3 mb-lg-0"><i
                                class="fa fa-mobile-alt me-2"></i> +91 456 7890</a>
                        <div class="navbar-nav ms-auto py-0">
                            <livewire:frontend.shoppingcartcount />
                        </div>
